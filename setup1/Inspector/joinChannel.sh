...
setGlobalsForPeer0Org2() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/../../artifacts/channel/crypto-config/peerOrganizations/inspector/users/Admin@inspector/msp
    export CORE_PEER_ADDRESS=localhost:9051
    export ANCHOR_NODE="InspectorMSP"
}
